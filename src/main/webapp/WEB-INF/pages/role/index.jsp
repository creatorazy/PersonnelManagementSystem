            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <div class="layui-inline layui-show-xs-block">
                        <input type="text" id="name" name="name" placeholder="角色名称" autocomplete="off"
                               class="layui-input">
                    </div>
                    <div class="layui-inline layui-show-xs-block">
                ...
                <table class="layui-hide" id="role" lay-filter="barDemo"></table>
            </div>
...
<script type="text/html" id="barDemo">
    <shiro:hasPermission name="role:upPage">
...
<script>
    ...
    function opens() {
        rowData = "";
        rowObj = "";
        xadmin.open('添加角色','<%=request.getContextPath()%>/pages/role/add',700,600);
    }
    ...
    layui.use(['table', "laytpl"], function () {
        ...
        table.render({
            id: "role"
            , elem: '#role'
            , url: '<%=request.getContextPath()%>/role/query'
            ...
            , cols: [[
                ...
                , {field: 'details', title: '角色描述', align: "center"}
        ...
        delCheck = function delCheck() {
            let checkStatus = table.checkStatus('role'); //idTest 即为基础参数 id 对应的值
            let arr = [];
        ...
        table.on('tool(barDemo)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                rowData = obj.data;
                xadmin.open('编辑用户信息', '<%=request.getContextPath()%>/pages/role/up', 700, 600);
            }
        });
